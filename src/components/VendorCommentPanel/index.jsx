        ...
        >
            <div className="offcanvas-header flex-column border-bottom border-secondary px-4 pt-20 pb-4">
                ...
                <div className="d-flex align-items-center justify-content-between w-100">
                    <span className="fs-12 fw-400 text-black text-nowrap">Add Comment labels</span>
                    <div className="form-floating ms-12 w-100">
                        <select className="form-select fs-12 fw-600 text-color-list-item bg-color-light-gray-shade border-0 pe-40" id="floatingPkoIdSelect" aria-label="Floating PKO ID select">
                            <option selected>PRJ 1188</option>
                            <option value="1">One</option>
                            <option value="2">Two</option>
                            <option value="3">Three</option>
                        </select>
                        <label for="floatingPkoIdSelect" className="fs-10 fw-600 text-color-typo-primary">PKO ID</label>
                    </div>
                    <div className="form-floating ms-12 w-100">
                        <select className="form-select fs-12 fw-600 text-color-list-item bg-color-light-gray-shade border-0 pe-40" id="floatingSkuSelect" aria-label="Floating SKU select">
                            <option selected>Select</option>
                            <option value="1">One</option>
                            <option value="2">Two</option>
                            <option value="3">Three</option>
                        </select>
                        <label for="floatingSkuSelect" className="fs-10 fw-600 text-color-typo-primary">SKU</label>
                    </div>
                    <div className="form-floating ms-12 w-100">
                        <select className="form-select fs-12 fw-600 text-color-list-item bg-color-light-gray-shade border-0 pe-40" id="floatingComponentSelect" aria-label="Floating PKO ID select">
                            <option selected>Select</option>
                            <option value="1">One</option>
                            <option value="2">Two</option>
                            <option value="3">Three</option>
                        </select>
                        <label for="floatingComponentSelect" className="fs-10 fw-600 text-color-typo-primary">Component</label>
                    </div>
                </div>
            </div>
            <div className="offcanvas-body bg-color-light-gray-shade p-0 h-100">
                <div className="p-4 pb-3">
                    <h2 className="fs-16 fw-600 mb-0 text-black">
                        All Comments
                        <span className="badge fs-14 fw-600 rounded-4 px-3 py-6 ms-2 text-secondary bg-color-badge">11</span>
                    </h2>
                    <div className="d-flex align-items-center justify-content-between mt-12">
                        <span className="fs-12 fw-400 text-color-list-item">Showing all comments</span>
                        <button
                            type="button"
                ...
                <div class="collapse" id="collapseChooseFilters">
                    <div class="card card-body bg-color-light-gray-shade-new rounded-0 border-0 border-bottom border-color-black px-4 py-14">
                        <div className="d-flex align-items-center justify-content-between mb-2">
                            <span className="fs-14 fw-400 text-color-typo-secondary">Choose Filters</span>
                            <button
                                type="button"
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div className="d-flex align-items-center">
                                ...
                                <select
                                    className="fs-14 fw-600 text-color-list-item bg-transparent form-list p-6 pe-40 border-0 border-bottom border-color-black border-2 rounded-0"
                                >
                    ...
                    <div className="card bg-white rounded-3 border-color-light-gray-shade mb-20">
                        <div className="card-header d-flex align-items-center justify-content-between border-0 bg-transparent px-3 pt-12 pb-0">
                            <div className="d-flex align-items-center">
                                ...
                                />
                                <div className="ms-10">
                                    <h3 className="fs-14 fw-600 text-color-typo-primary mb-1">Administrator</h3>
                                    <h4 className="fs-14 fw-400 text-color-typo-secondary mb-0">Mar 24, 2025</h4>
                                </div>
                            </div>
                            <div className="d-flex align-items-center">
                                <button
                        ...
                        <div className="card-body px-3 pt-2 pb-14">
                            <p className="fs-14 fw-400 text-color-typo-primary mb-0">Could you please provide clarification on the details for the Material Type field?</p>
                        </div>
                            ...
                            <div className="row">
                                <div className="col-6">
                                    <div className="row gx-2">
                                        <div className="col-4">
                                            <span className="fs-12 fw-400 text-color-typo-secondary">PKO ID</span>
                                        </div>
                                        <div className="col-8">
                                            <span className="fs-12 fw-600 text-color-typo-primary">PRJ 1188</span>
                                        </div>
                                    </div>
                                    <div className="row gx-2">
                                        <div className="col-4">
                                            <span className="fs-12 fw-400 text-color-typo-secondary">SKU</span>
                                        </div>
                                        <div className="col-8">
                                            <span className="fs-12 fw-600 text-color-typo-primary">CVS Ibuprofen 200mg</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-6">
                                    <div className="row gx-2">
                                        <div className="col-4">
                                            <span className="fs-12 fw-400 text-color-typo-secondary">Component</span>
                                        </div>
                                        <div className="col-8">
                                            <span className="fs-12 fw-600 text-color-typo-primary">Box</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="collapse p-3 bg-white border-top border-color-desabled-lite rounded-bottom-3" id="collapseExcessBlock">
                            {/* Replies Block */}
                            <div className="repliesBlock mb-3 pb-3 border-bottom position-relative">
                                ...
                                <div className="repliedBox ms-2 ps-20 pt-20">
                                    <div className="d-flex align-items-center position-relative">
                                        ...
                                        />
                                        <div className="ms-10">
                                            <h3 className="fs-14 fw-600 text-color-typo-primary mb-1">Elvira Mosley (You)</h3>
                                            <h4 className="fs-14 fw-400 text-color-typo-secondary mb-0">Mar 25, 2025</h4>
                                        </div>
                                    </div>
                                    <p className="fs-14 fw-400 text-color-typo-primary mt-2 mb-0">It refers to the specific materials used in the packaging i.e.,plastic & cardboard.</p>
                                </div>
                                <div className="repliedBox ms-2 ps-20 pt-20">
                                    <div className="d-flex align-items-center position-relative">
                                        <img
                                        ...
                                        <div className="ms-10">
                                            <h3 className="fs-14 fw-600 text-color-typo-primary mb-1">Administrator</h3>
                                            <h4 className="fs-14 fw-400 text-color-typo-secondary mb-0">Apr 1, 2025</h4>
                                        </div>
                                    </div>
                                    <p className="fs-14 fw-400 text-color-typo-primary mt-2 mb-0">Yes, that is correct.</p>
                                </div>
                            </div>
                            {/* Enter Reply Block */}
