  ...
  return (
    <div className="position-relative d-inline-block" ref={popoverRef}>
      ...
      {show && (
        ...
        >
          <div className="popover-arrow" style={{ position: 'absolute', left: '59%' }}></div>
          <div className="popover-body p-0">
            <div>
              <div className="d-flex align-items-center p-20 border-bottom border-color-desabled-lite">
                <p className="fs-14 fw-400 text-black text-nowrap mb-0"><span class="me-12"><img src={icon} alt="error-icon" /></span>{title}</p>
              </div>
              <div className="d-flex align-items-center justify-content-between px-12 py-12">
                <p className="fs-14 fw-600 text-black text-nowrap mb-0">{confirmTxt}</p>
                <div className="d-flex align-items-center">
                  <button className="btn btn-outline-primary fs-14 fw-600 px-4 py-2 rounded-1 me-12">No</button>
                  <button className="btn btn-primary fs-14 fw-600 px-4 py-2 rounded-1">Yes</button>
                </div>
              </div>
            </div>
          </div>
