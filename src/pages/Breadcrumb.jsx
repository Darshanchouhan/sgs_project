...
// import backActionIcon from "./../../public/assets/images/back-action-icon.svg";
// import addCommentIcon from "./../../public/assets/images/add-comment-icon.svg";
        ...
        <div className="d-flex align-items-center justify-content-between">
          ...
          <div className="d-flex align-items-center">
            <button
              ...
              className="btn p-0 border-none bg-transparent me-4"
            >
              <img src="/assets/images/add-comment-icon.svg" alt="icon" />
            </button>
