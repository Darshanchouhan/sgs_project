      ...
      >
        ...
        <div>
          ...
          <table className="table table-bordered fs-14 w-100 bg-transparent table-striped component-tbl mt-4">
            ...
            <tbody>
              <tr>
                <td className="text-start align-middle">Box</td>
                <td className="align-middle">Name_1108</td>
              ...
              <tr>
                <td className="text-start align-middle">Bottle Body</td>
                <td className="align-middle">Name_1109</td>
                <td className="text-center align-middle">
                  <img
                    src="/assets/images/forward-arrow-img.png"
                    alt="Forward"
              ...
              <tr>
                <td className="text-start align-middle">Label Wrap</td>
                <td className="align-middle">Name_1110</td>
                <td className="text-center align-middle">
                  <img
                    src="/assets/images/forward-arrow-img.png"
                    alt="Forward"
