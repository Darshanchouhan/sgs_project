...
const SKUDetailsSubHeaderStrip = ({descriptionIncoming , statusIncoming, submitted_date,setApiCallAgain}) => {
        ...
        <div className="d-flex align-items-center justify-content-between">
          <div className="d-flex flex-column">
            ...
            <div className="d-flex align-items-center mt-2">
              ...
              <span className={`fs-14 fw-600 text-nowrap px-18 py-6 d-inline-block border rounded-pill ${statusIncoming === "Inreview" ? "in-review-pill" : "not-started-pill"}`}>
