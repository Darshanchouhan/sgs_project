...
const CommentPanel = () => {
  return (
    <div
      ...
      tabIndex="-1"
      id="offcanvasCommentPanel"
      aria-labelledby="offcanvasCommentPanelLabel"
    >
      <div className="offcanvas-header flex-column px-4 pt-4 pb-12">
        ...
        <div className="d-flex flex-column mb-40 w-100">
          <label
            ...
            className="fs-14 fw-400 text-color-typo-primary mb-2"
          >
            Send a comment
          </label>
          ...
          <button
            type="button"
            className="btn btn-secondary px-4 py-2 fs-14 fw-600 mt-2 w-mx-content ms-auto"
          >
            Comment
            <img
