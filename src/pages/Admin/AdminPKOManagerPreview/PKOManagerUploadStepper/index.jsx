    ...
    return (
        <div className="py-4 bg-white rounded-3 d-flex align-items-center mb-3 w-100">
            ...
            <div className="w-100 h-100 d-flex flex-column justify-content-center px-4 border-start border-end border-color-desabled-lite">
                ...
                <div className="btn-group w-mx-content mt-12 ms-40" role="group" aria-label="Basic outlined example">
                    <button type="button" className="btn btn-outline-primary fs-12 text-secondary bg-color-light-shade text-decoration-underline border-color-typo-secondary border-end-0 px-12 py-6">Delete</button>
                    <button type="button" className="btn fs-12 text-color-labels text-start border-color-typo-secondary border-start-0 px-12 pe-4 py-6">TemplateFile.pdf</button>
                </div>
            </div>
            <div className="w-100 h-100 d-flex flex-column justify-content-center px-4">
                <div className="d-flex align-items-center">
