...
const ComponentSubHeaderStrip = ({skuComponentDataIncoming, componentsAllId, setLoading, setApiCallAgain}) => {
        ...
        <div className="d-flex align-items-center justify-content-between">
            ...
            <div className="d-flex align-items-center mt-2">
              ...
              >
                <img
                  ...
                  alt="Back Icon"
                  onClick={() =>
                      navigate(`/admincomponent/${pkoId}/${skuId}/${handleClick("Previous")}`)}
                />
              </button>
              ...
              >
                <img
                  ...
                  alt="Back Icon"
                  onClick={() =>
                      navigate(`/admincomponent/${pkoId}/${skuId}/${handleClick("Next")}`)}
                />
              </button>
            </div>
          </div>
          <div className="d-flex align-items-center">
            <span className="fs-16 fst-italic text-black">
              Date Submitted: {formatDateToReadableString(skuComponentDataIncoming?.updated_date)}
            </span>
