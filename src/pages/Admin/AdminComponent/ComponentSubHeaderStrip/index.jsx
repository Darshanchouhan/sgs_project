            ...
            <div className="container-fluid px-20 px-md-4">
                <div className="d-flex align-items-center justify-content-between">
                    ...
                    <div className="d-flex align-items-center">
                        <span className="fs-16 fst-italic text-black">Date Submitted: 5 May 2025</span>
                        <button type="button" className="btn btn-outline-secondary px-4 py-10 fs-14 fw-600 mx-3" data-bs-toggle="modal" data-bs-target="#requestChangesModal">
                            Request Changes
                        </button>
                        <button type="button" className="btn text-white bg-color-blue px-4 py-10 fs-14 fw-600" data-bs-toggle="modal" data-bs-target="#approveSKUModal">
                            Approve SKU
                        </button>
                    </div>
                </div>
