          ...
          <div className="row">
              ...
              <div className="form-group mt-4">
                ...
                <div className="input-group align-items-center">
                  <input
                    ...
                    tabIndex="0"
                    value="Paperboard box to contain product"
                    readOnly
                  />
                </div>
              </div>
            ...
            <div className="col-12 col-md-6">
              <div className="form-group mt-4">
                <div className="d-flex justify-content-between align-items-center mb-2 h-26">
                  <label className="mb-0">
                    Length <span className="text-secondary">*</span>
                  </label>
                  <span className="ms-2">
                    <div>
                      <InfoOutlinedIcon className="info-icon" />
            ...
            <div className="col-12 col-md-6">
              <div className="form-group mt-4">
                <div className="d-flex justify-content-between align-items-center mb-2 h-26">
                  <label className="mb-0 ">
                    What type of closure is used in the packaging?{" "}
                    <span className="text-secondary">*</span>
                  </label>
                  <span className="ms-2">
                    <div>
                ...
                <div className="align-items-center me-2">
                  ...
                  <label className="me-3">
                    <input type="radio" className="me-2" name="01" value="No" />
                    No
                  </label>
                </div>
              </div>
